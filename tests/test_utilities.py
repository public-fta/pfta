...
class TestUtilities(unittest.TestCase):
    def test_format_number(self):
        ...
        self.assertEqual(format_number(0, decimal_places=3, simple_zero=False), '0.000')
        self.assertEqual(format_number(0., decimal_places=0, simple_zero=False), '0')
        self.assertEqual(format_number(0., decimal_places=1, simple_zero=False), '0.0')
        self.assertEqual(format_number(0., decimal_places=2, simple_zero=False), '0.00')
        self.assertEqual(format_number(0., decimal_places=3, simple_zero=False), '0.000')
        ...
        self.assertEqual(format_number(0, significant_figures=1, simple_zero=False), '0')
        self.assertEqual(format_number(0, significant_figures=2, simple_zero=False), '0.0')
        self.assertEqual(format_number(0, significant_figures=3, simple_zero=False), '0.00')
        self.assertEqual(format_number(0., significant_figures=1, simple_zero=False), '0')
        self.assertEqual(format_number(0., significant_figures=2, simple_zero=False), '0.0')
        self.assertEqual(format_number(0., significant_figures=3, simple_zero=False), '0.00')
        self.assertEqual(format_number(-0., significant_figures=1, simple_zero=False), '-0')
