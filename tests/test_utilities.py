...
class TestUtilities(unittest.TestCase):
    def test_format_number(self):
        ...
        self.assertEqual(format_number(9.87654, significant_figures=1, force_scientific_exponent=0), '1E+1')
        self.assertEqual(format_number(9.87654, significant_figures=2, force_scientific_exponent=0), '9.9E+0')
        self.assertEqual(format_number(9.87654, significant_figures=3, force_scientific_exponent=0), '9.88E+0')
        self.assertEqual(format_number(9.87654, significant_figures=1, force_scientific_exponent=1), '1E+1')
        self.assertEqual(format_number(9.87654, significant_figures=2, force_scientific_exponent=1), '9.9')
        self.assertEqual(format_number(9.87654, significant_figures=3, force_scientific_exponent=1), '9.88')
        ...
        self.assertEqual(format_number(0.00999, significant_figures=1, force_scientific_exponent=3), '0.01')
        self.assertEqual(format_number(0.00999, significant_figures=2, force_scientific_exponent=3), '0.010')
        self.assertEqual(format_number(0.00999, significant_figures=3, force_scientific_exponent=3), '9.99E-3')
        self.assertEqual(format_number(0.00999, significant_figures=1, force_scientific_exponent=4), '0.01')
        self.assertEqual(format_number(0.00999, significant_figures=2, force_scientific_exponent=4), '0.010')
        self.assertEqual(format_number(0.00999, significant_figures=3, force_scientific_exponent=4), '0.00999')
        ...
        self.assertEqual(format_number(0.00999, significant_figures=3, force_scientific_exponent=5), '0.00999')
